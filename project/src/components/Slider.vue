...
export default {
  ...
  methods: {
    nextSlide() {
      let div =  document.querySelector(".current-num");
      let curNum = parseInt(div.innerHTML[2]);
      if (curNum === 8) {
        curNum = 1;
      } else {
        curNum++;
...
<template>
  <div class="container">
    ...
    <div class="row slick">
      <div id="review-carousel" class="carousel slide carousel-fade content" data-ride="carousel">
        ...
        <div class="buttons">
          <button @click="prevSlide" type="button" href="#review-carousel" role="button" data-slide="prev" class="carousel-control-prev arrow prev-button" aria-label="Previous">Previous</button>
          <span class="num">
          ...
          <button @click="nextSlide" type="button" href="#review-carousel" data-role="none" data-slide="next" class="carousel-control-next arrow next-button" aria-label="Next">Next</button>
        </div>
        <div class="back1"></div>
        <div class="back2"></div>
      </div>
