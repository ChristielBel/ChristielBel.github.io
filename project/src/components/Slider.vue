...
export default {
  ...
  mounted() {
    // Call transitionStart manually after a short delay
    setTimeout(() => {
...
.carousel-inner {
  transition: width 0.5s ease, height 0.5s ease; /* Добавьте эту строку для плавного перехода по ширине */
  overflow: hidden; /* Эта строка гарантирует, что содержимое слайда не выходит за его границы */
}
